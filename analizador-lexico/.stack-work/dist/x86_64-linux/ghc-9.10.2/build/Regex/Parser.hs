...
#endif
newtype HappyWrap5 = HappyWrap5 (RegEx)
happyIn5 :: (RegEx) -> (HappyAbsSyn )
happyIn5 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap5 x)
{-# INLINE happyIn5 #-}
happyOut5 :: (HappyAbsSyn ) -> HappyWrap5
happyOut5 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut5 #-}
newtype HappyWrap6 = HappyWrap6 (RegEx)
happyIn6 :: (RegEx) -> (HappyAbsSyn )
happyIn6 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap6 x)
{-# INLINE happyIn6 #-}
happyOut6 :: (HappyAbsSyn ) -> HappyWrap6
happyOut6 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut6 #-}
newtype HappyWrap7 = HappyWrap7 (RegEx)
happyIn7 :: (RegEx) -> (HappyAbsSyn )
happyIn7 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap7 x)
{-# INLINE happyIn7 #-}
happyOut7 :: (HappyAbsSyn ) -> HappyWrap7
happyOut7 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut7 #-}
newtype HappyWrap8 = HappyWrap8 (RegEx)
happyIn8 :: (RegEx) -> (HappyAbsSyn )
happyIn8 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap8 x)
{-# INLINE happyIn8 #-}
happyOut8 :: (HappyAbsSyn ) -> HappyWrap8
happyOut8 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut8 #-}
newtype HappyWrap9 = HappyWrap9 (RegEx)
happyIn9 :: (RegEx) -> (HappyAbsSyn )
...
happyTokenStrings = ["empty","epsilon","character","union","concat","kleene","'('","')'","%eof"]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyRuleArr = HappyA# ""#
...
happyReduction_10 happy_x_1
         =  case happyOutTok happy_x_1 of { (CharacterS happy_var_1) -> 
        happyIn9
...
happyTerminalToTok term = case term of {
        EmptyS -> 2#;
        EpsilonS -> 3#;
        CharacterS happy_dollar_dollar -> 4#;
        UnionS -> 5#;
        ConcatS -> 6#;
        KleeneS -> 7#;
        OpenParenthesis -> 8#;
